...
namespace Lab6
{
    ...
    public sealed class CreationTests
    {
        ...
        public async Task TestMethod1(int id, string name, string email)
        {
            int filecount = (Directory.GetFiles(".\\Data")).Count() + 1;
            string tempfilepath = ".\\Data\\Users" + filecount.ToString() + ".csv";
        ...
        {
            int filecount = (Directory.GetFiles(".\\Data")).Count() + 1;
            string tempfilepath = ".\\Data\\Books" + filecount.ToString() + ".csv";
